...
- **Minor (1.x):** New agent additions or significant policy updates (e.g., v1.1 Governance Agent)
- **Patch (1.0.x):** Documentation corrections, template updates, minor policy clarifications
...
Software projects built under the framework follow their own versioning independent of the framework version. Project release plans are defined by the Product Manager Agent.

## Decision Log Versioning

Framework decisions are numbered sequentially (DEC-001, DEC-002, ...). Project decisions use the same format within the project repository's decision log.

## Branch and Tag Strategy

- Framework development uses feature branches: `feature/framework-baseline-v1`, `feature/governance-agent-v1.1`, etc.
