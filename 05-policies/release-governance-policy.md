...
Connect governance controls to Gate 6 (Release Approval) so release decisions are based
...
Release governance uses
[Gate 6 — Release Approval](../04-approval-gates/gate-6-release-approval.md).

Governance Agent supports Gate 6 by defining what evidence must exist before the Human
Decision Approver approves release.
...
Builder Agent output alone is not sufficient for release. Release requires Gate 6
approval supported by governance, testing, deployment readiness, and documentation
evidence as defined for the project risk level.
