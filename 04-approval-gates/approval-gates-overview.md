...
Approval gates are mandatory checkpoints where the Human Decision Approver reviews agent deliverables and makes go / no-go decisions before the project proceeds.
...
No agent may proceed to the next phase until the relevant gate is approved by the Human Decision Approver.
