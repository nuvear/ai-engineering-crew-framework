...
The Product Manager Agent converts approved requirements into product scope, MVP definition, feature priorities, roadmap, release plan, and success metrics.
